...
JOBID1=$($SUB_CMD vasp_runscript_step1 | awk '{print $1}')
echo "Submitted Step 1 with PBS JobID: $JOBID1" >> $LOGFILE
...
cp CONTCAR POSCAR
JOBID2=$($SUB_CMD vasp_runscript_step2 | awk '{print $1}')
echo "Submitted Step 2 with PBS JobID: $JOBID2" >> $LOGFILE
...
JOBID3=$($SUB_CMD vasp_runscript_scf | awk '{print $1}')
echo "Submitted Step 3 with PBS JobID: $JOBID3" >> ../$LOGFILE
